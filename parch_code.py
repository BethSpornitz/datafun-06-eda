#####This code was originally meant to see of "women traveling with children (mothers)" were more likely to survive than women traveling without children.  My hypothesis was that mothers had a better chance at survival.  This is also what Google and a peer reviewed publication says.  So, when my results turned out different, I had to dig deeper.  it turns out that with the dataset in Seaborn I don't think it is possible to tell this.  The parch column is "parents and children traveling together".  From my understanding, you don't know whether this is a 25 year old woman with children or a 25 year old women traveling with her parents (in which case she may not have kids but would still show up at >0 for  the parch column).  So, this was excluded from my analysis.
